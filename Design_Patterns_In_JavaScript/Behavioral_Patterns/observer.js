...
class Auctioneer{
    ...
    announceNewBidderPrice = () => this.notifyBidders()
     
    registerBidder = (bidder) => this.bidderList.push(bidder)
    
    notifyBidders = () => this.bidderList.forEach(bidder => bidder.update())
}
...
class Bidder {
    ...
    giveNewPrice = (price) => this.bidPrice = price
}
